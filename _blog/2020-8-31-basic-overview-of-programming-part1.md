...
lang: fa-IR
dir_attr: rtl
description: "مرور مفاهیم پایه برنامه‌نویسی؛ الگوریتم، متغیر، و شروع کدنویسی با C و پایتون."
date: 2020-08-31
...
<img src="/assets/images/compiler.png" alt="نمودار کامپایلر: تبدیل کد سطح بالا به فایل اجرایی">
...
<img src="/assets/images/Interpreter.png" alt="نمودار مفسر: اجرای خط‌به‌خط برنامه">
